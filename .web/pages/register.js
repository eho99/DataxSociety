...
export default function Component() {
  ...
  <Box as={`form`} className={`space-y-6`} onSubmit={(_e0) => addEvents([Event("state.registration_state.handle_registration", {form_data:{"username": getRefValue(ref_username), "confirm_password": getRefValue(ref_confirm_password), "password": getRefValue(ref_password)}})], (_e0))}>
